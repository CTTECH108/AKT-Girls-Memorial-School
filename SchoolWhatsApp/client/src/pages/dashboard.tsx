        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-2 text-white hover:text-white no-underline">
              ...
              <span className="text-xl font-bold">MESSAGE SENDER PLATFORM AKT MEMORIAL MATRIC GIRLS SCHOOL,NEELAMANGALAM KALLAKURICHI.606213.</span>
            </Link>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Designed By CT Solutions</span>
              </div>
            </div>
          </div>
        </div>
